...
export default function Footer() {
  ...
  <div className="inline-flex items-center">
    <a href="https://imgbb.com/">
      <img 
        src="https://i.ibb.co/wpD9cP3/bg-removed.png" 
        alt="bg-removed" 
        border="0" 
        style={{ width: '200px', height: 'auto' }} // Set smaller width here
      />
    </a>
    <span className="ml-4 text-lg font-bold"></span>
          ...
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              ...
              <li className="p-5">
              <Link className="font-medium text-gray-600 hover:text-gray-700" to="/return-policy">
            Return Policy
          </Link>
              </li>
              <li className="p-5">
              <Link className="font-medium text-gray-600 hover:text-gray-700" to="/contact-us">
            Contact us
          </Link>
              </li>
            </ul>
